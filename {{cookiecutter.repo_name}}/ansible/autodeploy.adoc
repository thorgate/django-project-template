...
----
Key: DPT_AUTO_DEPLOY_TEST_VAULT_PASSWORD
Type: File
Protect: No
Mask: Yes
...
----
Key: DPT_AUTO_DEPLOY_LIVE_VAULT_PASSWORD
Type: File
Protect: Yes
Mask: Yes
----

Also create/update the environment variable `SSH_KNOWN_HOSTS` based on instructions https://docs.gitlab.com/ci/jobs/ssh_keys/#verifying-the-ssh-host-keys[here].
...
----
include::roles/autodeploy/vault-template.yml[]
----
...
sudo rm -rf /home/{{ cookiecutter.repo_name }}-autodeploy
----
